          ...
          <section className="text-gray-600 body-font">
            <div className="container px-5 py-4 mx-auto">
              <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                ...
                <span className="inline-block h-1 w-10 rounded bg-main mt-8 mb-6"></span>
                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">
                  HOLDEN CAULFIELD
                </h2>
                <p className="text-gray-500">Senior Backend Developer</p>
              </div>
            </div>
          </section>
        </SwiperSlide>
            ...
            <div className="container px-5 py-4 mx-auto">
              <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                ...
                <p className="leading-relaxed text-lg">
                  ...
                  optio voluptatibus deserunt sequi, quidem nisi vel voluptatem
                  eligendi facilis reiciendis tenetur eius hic eum.
                  Consequuntur, explicabo. Perferendis eum architecto fuga.
                </p>
                <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-8 mb-6"></span>
                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">
                  ALPER KAMU
                </h2>
                <p className="text-gray-500">Senior Front-End Developer</p>
              </div>
            </div>
          </section>
        </SwiperSlide>
