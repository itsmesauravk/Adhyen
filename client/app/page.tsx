    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow">
        <div className="container mx-auto py-6 px-4 flex justify-between items-center">
          {/* font- monospacd */}
          <h1 className="text-3xl font-bold text-gray-900">𝙰𝚍𝚑𝚢𝚎𝚗</h1>
          <div>
            <Link href="/login">
              <button className="border-[#A435F0] bg-white text-[#A435F0] px-4 py-2 rounded mr-2 hover:font-bold">
                Log In
              </button>
            </Link>
            <Link href="/register">
              <Button className="bg-[#A435F0] hover:bg-[#842dc2] text-white px-4 py-2 rounded">
                Sign Up
              </Button>
            </Link>
          </div>
